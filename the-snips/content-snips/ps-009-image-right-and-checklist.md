---
description: >-
  PS-009 - This Player Snip has an image on the right of a heading, text and
  checklist
---

# Image (Right) & Checklist

<figure><img src="../../.gitbook/assets/164072custom_site_themesidzKgl49.jpeg" alt=""><figcaption></figcaption></figure>

**Adding this Player Snip**

* [ ] On your [`My Player Snips Page`](../../how-to-guides.md#how-to-create-a-my-snips-page) add the **`PS-009`** section to your page

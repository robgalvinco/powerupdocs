---
description: >-
  PS-003 - This Player Snip has a colored background with a heading and summary
  and call to action (placed on the side)
---
...
* [ ] On your [`My Player Snips Page`](../../how-to-guides.md#how-to-create-a-my-snips-page) add the **`PS-003`** section to your page

---
description: >-
  You will flip over this Player Snip. Hover over the card to reveal more
  information and an optional call to action
---

# PS-038 Flip Hover Cards (CTA)

<figure><img src="../../.gitbook/assets/Player Snips Thumbs (36).jpg" alt=""><figcaption></figcaption></figure>

**Adding this Player Snip**

* [ ] On your [`My Player Snips Page`](../../how-to-guides.md#how-to-create-a-my-snips-page) add the **`PS-038`** section to your page

---
description: >-
  PS-021 - With this Player Snip, you can create a list of resource cards with
  images and a call to action
---

# CTA Cards Side by Side

<figure><img src="../../.gitbook/assets/164072custom_site_themesidXgX9mo.jpeg" alt=""><figcaption></figcaption></figure>

**Adding this Player Snip**

* [ ] On your [`My Player Snips Page`](../../how-to-guides.md#how-to-create-a-my-snips-page) add the **`PS-021`** section to your page
